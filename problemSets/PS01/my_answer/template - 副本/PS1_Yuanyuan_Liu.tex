...
\begin{lstlisting}[language=R]
	...
	\lstinputlisting[language=R, firstline=40, lastline=113]{PS1_Yuanyuan_Liu.R}
...
\lstinputlisting[language=R, firstline=123, lastline=150]{PS1_Yuanyuan_Liu.R}
\noindent Estimate an OLS regression using BFGS:\\
(Intercept)                   x \\
0.1391778 2.7267000 \\
